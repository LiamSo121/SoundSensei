...
spotify.emotion = face.activate_camera()
print(f"Chosen Emotion:{spotify.emotion}")
...
# # Start Spotify
# player.start_playback(uris=track_uris,device_id=spotify)
# time.sleep(3)
...
activate_hand_gestures_model(spotify.sp)
# Close Chrome
driver.close()
